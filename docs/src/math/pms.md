...
- *贝叶斯公式（揉合了上列两者）*：$P(B_i|A)=\dfrac{P(A|B_i)P(B_i)}{\sum P(A|B_j)P(B_j)}$​
...
| ----------------- | --------------------------------------------------- | ------------------------------------------------------------ | -------------- | --------------------- |
| 两点分布/0-1分布  | $X\sim B(1,p)$                                      | <br>$P\{X=k\}=p^k(1-p)^{1-k}$<br>                            | $p$            | $p(1-p)$              |
...
| *标准正态分布*    | $X\sim\mu(0,1)$                                     | <br>$f(x)=\dfrac1{\sqrt{2\pi}}e^{-\frac{x^2}2}$<br>          | $0$            | $1$                   |
